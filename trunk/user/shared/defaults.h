...
#define DEF_WLAN_2G_SSID	"SuperNet_%s"
#define DEF_WLAN_5G_SSID	"SuperNet_%s_5G"
#define DEF_WLAN_2G_GSSID	"SuperNet_%s_GUEST"
#define DEF_WLAN_5G_GSSID	"SuperNet_%s_GUEST_5G"
